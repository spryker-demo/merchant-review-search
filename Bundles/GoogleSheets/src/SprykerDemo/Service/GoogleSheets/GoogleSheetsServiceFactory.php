...
use SprykerDemo\Service\GoogleSheets\SpreadsheetsReader\SpreadsheetsReader;
use SprykerDemo\Service\GoogleSheets\SpreadsheetsReader\SpreadsheetsReaderInterface;

/**
 * @method \SprykerDemo\Service\GoogleSheets\GoogleSheetsConfig getConfig()
 */
class GoogleSheetsServiceFactory extends AbstractServiceFactory
{
    /**
     * @return \SprykerDemo\Service\GoogleSheets\SpreadsheetsReader\SpreadsheetsReaderInterface
     */
    ...
    public function createGoogleClient(): Google_Client
    {
        ...
        $client->setAuthConfig($this->getConfig()->getGoogleSheetsCredentials());
