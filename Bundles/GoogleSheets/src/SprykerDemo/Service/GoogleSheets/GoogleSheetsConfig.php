...
class GoogleSheetsConfig extends AbstractBundleConfig
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected const APPLICATION_NAME = 'Google Sheets';
     ...
     * @return array<string>
     */
    public function getGoogleSheetsCredentials(): array
    {
        return $this->get(GoogleSheetsConstants::GOOGLE_SHEETS_CREDENTIALS, []);
    }
}
