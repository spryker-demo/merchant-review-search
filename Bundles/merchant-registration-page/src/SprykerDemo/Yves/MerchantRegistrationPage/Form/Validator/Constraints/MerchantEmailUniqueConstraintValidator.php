 ...
 */
class MerchantEmailUniqueConstraintValidator extends ConstraintValidator
{
    ...
    public function validate($value, Constraint $constraint): void
    {
        ...
        if (!$constraint instanceof MerchantEmailUniqueConstraint) {
            throw new UnexpectedTypeException($constraint, MerchantEmailUniqueConstraint::class);
        }

        $merchantTransfer = $constraint->getMerchantRegistrationClient()
            ->merchantExists(
                (new MerchantCriteriaTransfer())->setEmail($value),
            );
