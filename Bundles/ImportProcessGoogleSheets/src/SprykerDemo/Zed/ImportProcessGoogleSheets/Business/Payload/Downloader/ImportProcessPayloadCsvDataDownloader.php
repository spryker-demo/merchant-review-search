...
use Exception;
use SprykerDemo\Zed\ImportProcessGoogleSheets\Business\Exception\SpreadsheetDownloaderException;
...
class ImportProcessPayloadCsvDataDownloader extends AbstractImportProcessPayloadDataDownloader
{
  ...
  */
     ...
     * @param string $spreadsheetUrl
     *
     * @throws \SprykerDemo\Zed\ImportProcessGoogleSheets\Business\Exception\SpreadsheetDownloaderException
     *
     * @return string
     */
