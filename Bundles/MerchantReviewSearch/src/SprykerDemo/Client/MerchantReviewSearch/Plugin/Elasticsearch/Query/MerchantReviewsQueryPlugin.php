...
/**
 * @method \SprykerDemo\Client\MerchantReviewSearch\MerchantReviewConfig getFactory()
 */
class MerchantReviewsQueryPlugin extends AbstractPlugin implements QueryInterface, SearchContextAwareQueryInterface
{
    ...
    {
        $this->merchantReviewSearchRequestTransfer->requireSearchString();

        $merchantReviewsFilter = $this->getMatchQuery()
            ->setField(MerchantReviewIndexMap::ID_MERCHANT, $this->merchantReviewSearchRequestTransfer->getSearchString());
