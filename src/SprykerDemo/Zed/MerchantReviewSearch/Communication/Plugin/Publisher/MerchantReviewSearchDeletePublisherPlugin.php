 ...
 */
class MerchantReviewSearchDeletePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        $this->getFacade()->deleteCollectionByMerchantReviewEvents($eventEntityTransfers);
    }
